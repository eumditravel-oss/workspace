    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[150] p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-5 border-b border-gray-100 bg-blue-50">
          ...
          <button onClick={onClose} className="p-1.5 hover:bg-blue-100 rounded-full transition-colors text-blue-500">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">프로젝트 종합 요약</label>
            <textarea 
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">일정 난이도 의견</label>
            <textarea 
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">범위/난이도 의견</label>
            <textarea 
